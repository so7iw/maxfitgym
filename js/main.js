...
let tag = ["#offer","#contact","aboutus.html","#auth"]
    ...
    var options = [
        {
            ...
            descr: "My name is Miloš Stojanovski, I was born on the 11th of March 1998. in Pančevo. I finished the 3rd Grammar School in Belgrade and now I am studying at the ICT College. In addition, I work full time at Euronet Worldwide as a system analyst. I am creative, hard working, and always eager to learn something new and further advance in IT area of expertise. ",
        },
    ];
    var output = "";
    for (let obj of options){
